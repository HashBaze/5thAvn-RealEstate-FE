...
const TinySlider = dynamic(() => import("tiny-slider").then((mod) => mod.tns), {
  ssr: false,
});
  ...
  return (
    <div className="row">
      <div className="col-12">
        <div ref={sliderRef} className="tiny-slide-three">
            ...
            <div className="tiny-slide" key={index}>
              <div className="card property border-0 shadow position-relative overflow-hidden rounded-3 m-3">
                ...
                <div className="card-body content p-4">
                  <Link href={`/property-detail/${item.id}`} className="title fs-5 text-dark fw-medium">
                    {item.title}
                  </Link>
